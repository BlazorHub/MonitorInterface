...
namespace MonitorInterfaceBlazor
{
    public static class InitializeData
    {
        ...
        public static List<SendSlack> SendSlacks { get; set; }
        public static List<SlackChannel> SlackChannels { get; set; }
        ...
        public static void GetSendSlackDropdown()
        {
            List<SendSlack> sendSlack = new List<SendSlack>()
            {
                new SendSlack {SendSlackId = 0, SendSlackName = "Y", IsSendSlackSelected = false},
                new SendSlack {SendSlackId = 1, SendSlackName = "N", IsSendSlackSelected = false}
            };

            SendSlacks = sendSlack.ToList();
        }

        public static void GetSlackChannelDropdown()
        {
            List<SlackChannel> slackChannel = new List<SlackChannel>()
            {
                new SlackChannel {SlackChannelId = 0, SlackChannelName = "#alerts", IsSendSlackChannelSelected = false},
                new SlackChannel {SlackChannelId = 1, SlackChannelName = "#testspam", IsSendSlackChannelSelected = false}
            };

            SlackChannels = slackChannel.ToList();
        }
